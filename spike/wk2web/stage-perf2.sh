...
FILES=""
for f in "$WKT/build/tiger-ui-perf/bin/TigerWK2App" "$WKT/build/tiger-ui-perf/bin/TigerBrowser2" "$WKT/$WEBDIR/bin/TigerWebProcess" "$WKT/$WEBDIR/bin/TigerNetworkProcess" "$WKT/build/tiger-gpu/bin/TigerGPUProcess"; do
