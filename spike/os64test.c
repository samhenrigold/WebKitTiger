 ...
 * Tiger ships no 64-bit CoreFoundation, so libtigerdispatch's x86_64 build is os.c
 * alone: os_log, os_unfair_lock, os_signpost and sys/qos, but no dispatch. Build:
