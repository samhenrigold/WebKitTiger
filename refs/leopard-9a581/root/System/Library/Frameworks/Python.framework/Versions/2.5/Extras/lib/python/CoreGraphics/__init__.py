...
class QDPict(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, QDPict, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, QDPict, name)
    def __init__(self): raise AttributeError, "No constructor defined"
    __repr__ = _swig_repr
    __swig_destroy__ = _CoreGraphics.delete_QDPict
    __del__ = lambda self : None;
    def getBounds(*args): return _CoreGraphics.QDPict_getBounds(*args)
    def getResolution(*args): return _CoreGraphics.QDPict_getResolution(*args)
    def drawToCGContext(*args): return _CoreGraphics.QDPict_drawToCGContext(*args)
QDPict_swigregister = _CoreGraphics.QDPict_swigregister
QDPict_swigregister(QDPict)

QDPictCreateWithProvider = _CoreGraphics.QDPictCreateWithProvider
QDPictCreateWithFilename = _CoreGraphics.QDPictCreateWithFilename
