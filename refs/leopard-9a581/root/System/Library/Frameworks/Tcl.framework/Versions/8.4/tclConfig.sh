...
# build directory.
TCL_BUILD_LIB_SPEC='-F/var/tmp/tcl/tcl-64~33/tcl/Deployment -framework Tcl'
...
# compiled.
TCL_SRC_DIR='/BinaryCache/tcl/tcl-64~33/Symbols/SRC/tcl/tcl'
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/var/tmp/tcl/tcl-64~33/tcl/Deployment -ltclstub8.4${TCL_DBGX}'
...
TCL_BUILD_STUB_LIB_PATH='/var/tmp/tcl/tcl-64~33/tcl/Deployment/libtclstub8.4${TCL_DBGX}.a'
