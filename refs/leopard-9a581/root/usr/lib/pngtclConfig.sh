...
# build directory.
pngtcl_BUILD_LIB_SPEC='-L/var/tmp/tcl_ext/tcl_ext-64~32/tcl_ext/tkimg/libpng/tcl -lpngtcl1.0'
...
# build directory.
pngtcl_BUILD_STUB_LIB_SPEC='-L/var/tmp/tcl_ext/tcl_ext-64~32/tcl_ext/tkimg/libpng/tcl -lpngtclstub1.0'
...
# String to pass to linker to pick up the pngtcl stub library from its
# build directory.
pngtcl_BUILD_STUB_LIB_PATH='/var/tmp/tcl_ext/tcl_ext-64~32/tcl_ext/tkimg/libpng/tcl/libpngtclstub1.0.a'
...
pngtcl_SRC_DIR='/BinaryCache/tcl_ext/tcl_ext-64~32/Symbols/SRC/tcl_ext/tkimg/tkimg/libpng/tcl'
