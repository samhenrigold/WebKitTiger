...
# build directory.
Tcldom_BUILD_LIB_SPEC='-L/var/tmp/tcl_ext/tcl_ext-64~32/tcl_ext/tclxml/tcldom -lTcldom2.6'
...
# build directory.
Tcldom_BUILD_STUB_LIB_SPEC='-L/var/tmp/tcl_ext/tcl_ext-64~32/tcl_ext/tclxml/tcldom -lTcldomstub2.6'
...
# String to pass to linker to pick up the Tcldom stub library from its
# build directory.
Tcldom_BUILD_STUB_LIB_PATH='/var/tmp/tcl_ext/tcl_ext-64~32/tcl_ext/tclxml/tcldom/libTcldomstub2.6.a'
...
Tcldom_SRC_DIR='/BinaryCache/tcl_ext/tcl_ext-64~32/Symbols/SRC/tcl_ext/tclxml/tcldom'
