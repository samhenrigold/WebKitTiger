...
# build directory.
jpegtcl_BUILD_LIB_SPEC='-L/var/tmp/tcl_ext/tcl_ext-64~32/tcl_ext/tkimg/libjpeg/tcl -ljpegtcl1.0'

# String to pass to linker to pick up the jpegtcl library from its
# installed directory.
jpegtcl_LIB_SPEC='-L/System/Library/Tcl/Img1.3 -ljpegtcl1.0'
...
# build directory.
jpegtcl_BUILD_STUB_LIB_SPEC='-L/var/tmp/tcl_ext/tcl_ext-64~32/tcl_ext/tkimg/libjpeg/tcl -ljpegtclstub1.0'

# String to pass to linker to pick up the jpegtcl stub library from its
# installed directory.
jpegtcl_STUB_LIB_SPEC='-L/System/Library/Tcl/Img1.3 -ljpegtclstub1.0'

# String to pass to linker to pick up the jpegtcl stub library from its
# build directory.
jpegtcl_BUILD_STUB_LIB_PATH='/var/tmp/tcl_ext/tcl_ext-64~32/tcl_ext/tkimg/libjpeg/tcl/libjpegtclstub1.0.a'

# String to pass to linker to pick up the jpegtcl stub library from its
# installed directory.
jpegtcl_STUB_LIB_PATH='/System/Library/Tcl/Img1.3/libjpegtclstub1.0.a'
...
jpegtcl_SRC_DIR='/BinaryCache/tcl_ext/tcl_ext-64~32/Symbols/SRC/tcl_ext/tkimg/tkimg/libjpeg/tcl'
