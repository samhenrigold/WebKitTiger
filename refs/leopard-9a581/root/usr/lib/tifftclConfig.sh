...
# build directory.
tifftcl_BUILD_LIB_SPEC='-L/var/tmp/tcl_ext/tcl_ext-64~32/tcl_ext/tkimg/libtiff/tcl -ltifftcl1.0'
...
# build directory.
tifftcl_BUILD_STUB_LIB_SPEC='-L/var/tmp/tcl_ext/tcl_ext-64~32/tcl_ext/tkimg/libtiff/tcl -ltifftclstub1.0'
...
# String to pass to linker to pick up the tifftcl stub library from its
# build directory.
tifftcl_BUILD_STUB_LIB_PATH='/var/tmp/tcl_ext/tcl_ext-64~32/tcl_ext/tkimg/libtiff/tcl/libtifftclstub1.0.a'
...
tifftcl_SRC_DIR='/BinaryCache/tcl_ext/tcl_ext-64~32/Symbols/SRC/tcl_ext/tkimg/tkimg/libtiff/tcl'
