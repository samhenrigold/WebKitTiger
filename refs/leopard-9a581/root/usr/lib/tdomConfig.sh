...
#
TDOM_STUB_FILE=libtdomstub0.8.0.a

#
# String to pass to linker to pick up the tDOM library from
# its build directory.
#
TDOM_BUILD_STUB_LIB_SPEC='-L/var/tmp/tcl_ext/tcl_ext-64~32/tcl_ext/tdom -ltdomstub0.8.0'

#
# String to pass to linker to pick up the tDOM library from
# its installed directory.
#
TDOM_STUB_LIB_SPEC='-L/System/Library/Tcl/tdom0.8.0 -ltdomstub0.8.0'
...
#
TDOM_SRC_DIR='/BinaryCache/tcl_ext/tcl_ext-64~32/Symbols/SRC/tcl_ext/tdom/tdom'
