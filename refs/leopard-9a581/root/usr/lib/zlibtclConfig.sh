...
# build directory.
zlibtcl_BUILD_LIB_SPEC='-L/var/tmp/tcl_ext/tcl_ext-64~32/tcl_ext/tkimg/libz/tcl -lzlibtcl1.0'
...
# build directory.
zlibtcl_BUILD_STUB_LIB_SPEC='-L/var/tmp/tcl_ext/tcl_ext-64~32/tcl_ext/tkimg/libz/tcl -lzlibtclstub1.0'
...
# String to pass to linker to pick up the zlibtcl stub library from its
# build directory.
zlibtcl_BUILD_STUB_LIB_PATH='/var/tmp/tcl_ext/tcl_ext-64~32/tcl_ext/tkimg/libz/tcl/libzlibtclstub1.0.a'
...
zlibtcl_SRC_DIR='/BinaryCache/tcl_ext/tcl_ext-64~32/Symbols/SRC/tcl_ext/tkimg/tkimg/libz/tcl'
