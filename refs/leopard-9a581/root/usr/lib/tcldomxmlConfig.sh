...
# build directory.
tcldomxml_BUILD_LIB_SPEC='-L/var/tmp/tcl_ext/tcl_ext-64~32/tcl_ext/tclxml/tcldom/src-libxml2 -ltcldomxml2.6'
...
# build directory.
tcldomxml_BUILD_STUB_LIB_SPEC='-L/var/tmp/tcl_ext/tcl_ext-64~32/tcl_ext/tclxml/tcldom/src-libxml2 -ltcldomxmlstub2.6'
...
# String to pass to linker to pick up the tcldomxml stub library from its
# build directory.
tcldomxml_BUILD_STUB_LIB_PATH='/var/tmp/tcl_ext/tcl_ext-64~32/tcl_ext/tclxml/tcldom/src-libxml2/libtcldomxmlstub2.6.a'
...
tcldomxml_SRC_DIR='/BinaryCache/tcl_ext/tcl_ext-64~32/Symbols/SRC/tcl_ext/tclxml/tcldom/src-libxml2'
