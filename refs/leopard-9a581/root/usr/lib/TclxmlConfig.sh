...
# build directory.
Tclxml_BUILD_LIB_SPEC='-L/var/tmp/tcl_ext/tcl_ext-64~32/tcl_ext/tclxml -lTclxml2.6'
...
# build directory.
Tclxml_BUILD_STUB_LIB_SPEC='-L/var/tmp/tcl_ext/tcl_ext-64~32/tcl_ext/tclxml -lTclxmlstub2.6'
...
# String to pass to linker to pick up the Tclxml stub library from its
# build directory.
Tclxml_BUILD_STUB_LIB_PATH='/var/tmp/tcl_ext/tcl_ext-64~32/tcl_ext/tclxml/libTclxmlstub2.6.a'
...
Tclxml_SRC_DIR='/BinaryCache/tcl_ext/tcl_ext-64~32/Symbols/SRC/tcl_ext/tclxml/tclxml'
