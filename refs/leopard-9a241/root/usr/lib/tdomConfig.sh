...
# its build directory.
#
TDOM_BUILD_STUB_LIB_SPEC='-L/var/tmp/tcl_ext/tcl_ext-46~3/tcl_ext/tdom -ltdomstub0.8.0'
...
#
TDOM_SRC_DIR='/BinaryCache/tcl_ext/tcl_ext-46~3/Symbols/SRC/tcl_ext/tdom/tdom'
