...
def svn_io_set_file_read_write_carefully(*args):
    """
    svn_io_set_file_read_write_carefully(char path, svn_boolean_t enable_write, svn_boolean_t ignore_enoent, 
        apr_pool_t pool) -> svn_error_t
    """
    return apply(_core.svn_io_set_file_read_write_carefully, args)
...
def svn_io_get_dirents2(*args):
    """svn_io_get_dirents2(apr_hash_t dirents, char path, apr_pool_t pool) -> svn_error_t"""
    return apply(_core.svn_io_get_dirents2, args)
...
def svn_io_file_move(*args):
    """svn_io_file_move(char from_path, char to_path, apr_pool_t pool) -> svn_error_t"""
    return apply(_core.svn_io_file_move, args)
class svn_stream_t:
