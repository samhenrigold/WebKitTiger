...
TCL_EXTRA_CFLAGS='  -g -Os -pipe -DTCL_IO_TRACK_OS_FOR_DRIVER_WITH_BAD_BLOCKING   -pipe'
...
# build directory.
TCL_BUILD_LIB_SPEC='-F/var/tmp/tcl/tcl-46~7/tcl/Deployment -framework Tcl'
...
# compiled.
TCL_SRC_DIR='/BinaryCache/tcl/tcl-46~7/Symbols/SRC/tcl/tcl'

# List of standard directories in which to look for packages during
# "package require" commands.  Contains the "prefix" directory plus also
# the "exec_prefix" directory, if it is different.
TCL_PACKAGE_PATH='/System/Library/Frameworks/Tcl.framework/Versions/8.4/Resources/Scripts'
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/var/tmp/tcl/tcl-46~7/tcl/Deployment -ltclstub8.4${TCL_DBGX}'
...
TCL_BUILD_STUB_LIB_PATH='/var/tmp/tcl/tcl-46~7/tcl/Deployment/libtclstub8.4${TCL_DBGX}.a'
