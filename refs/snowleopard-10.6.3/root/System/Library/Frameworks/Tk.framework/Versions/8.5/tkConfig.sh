...
# build directory.
TK_BUILD_LIB_SPEC='-F/var/tmp/tcl/tcl-87~1/tk/Deployment -framework Tk'
...
# build directory.
TK_BUILD_STUB_LIB_SPEC='-L/var/tmp/tcl/tcl-87~1/tk/Deployment -ltkstub8.5'
...
TK_BUILD_STUB_LIB_PATH='/var/tmp/tcl/tcl-87~1/tk/Deployment/libtkstub8.5.a'
