/*	NSWindow.h -- TIGER SDK OVERLAY
	The 10.4u SDK's header, unchanged, followed by the 10.12
	NSWindowStyleMask* renames. Same story as NSEvent: a respelling with no
	value changes. 13 WebKit sites across 8 files. */
...
/* Declared in <AppKit/NSPanel.h>, which AppKit.h pulls in before any use. */
...
/* 10.7 and 10.10. No Tiger equivalent, so the real bit values are used and a
   style-mask test against a Tiger window is simply always false. */
#define NSWindowStyleMaskFullScreen             (1 << 14)
#define NSWindowStyleMaskFullSizeContentView    (1 << 15)

typedef unsigned int NSWindowStyleMask;
