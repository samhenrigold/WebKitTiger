...
/* TIGER SDK OVERLAY: CFError is 10.5 and Tiger's umbrella header does not know
   about it. Included here so that CFErrorRef is available to anything that
   includes <CoreFoundation/CoreFoundation.h>, which is how every caller expects
   to get it. */
