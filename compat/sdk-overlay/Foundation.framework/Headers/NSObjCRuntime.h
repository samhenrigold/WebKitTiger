...
/* TIGER SDK OVERLAY: NSNotificationName, 10.10. It is a plain alias for
   NSString *, and PAL's NSWindowSPI.h and several WebCore headers declare
   notification names with it. The related NSString aliases Apple added at the
   same time are here too, for the same reason. */
#ifndef NSNOTIFICATIONNAME_DEFINED
#define NSNOTIFICATIONNAME_DEFINED 1
